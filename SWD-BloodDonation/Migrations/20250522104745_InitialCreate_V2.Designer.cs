...
namespace SWD_BloodDonation.Migrations
{
    ...
    [Migration("20250522104745_InitialCreate_V2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SWD_BloodDonation.Models.BlogPost", b =>
                {
            ...
            modelBuilder.Entity("SWD_BloodDonation.Models.BloodComponent", b =>
                {
            ...
            modelBuilder.Entity("SWD_BloodDonation.Models.BloodInventory", b =>
                {
            ...
            modelBuilder.Entity("SWD_BloodDonation.Models.BloodRequest", b =>
                {
            ...
            modelBuilder.Entity("SWD_BloodDonation.Models.BloodRequestInventory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SWD_BloodDonation.Models.BloodType", b =>
                {
                    b.Property<int>("BloodTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SWD_BloodDonation.Models.DonationHistory", b =>
                {
            ...
            modelBuilder.Entity("SWD_BloodDonation.Models.DonationRequest", b =>
                {
            ...
            modelBuilder.Entity("SWD_BloodDonation.Models.Notification", b =>
                {
            ...
            modelBuilder.Entity("SWD_BloodDonation.Models.RequestMatch", b =>
                {
            ...
            modelBuilder.Entity("SWD_BloodDonation.Models.User", b =>
                {
                    b.Property<int>("UserId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SWD_BloodDonation.Models.BlogPost", b =>
                {
                    b.HasOne("SWD_BloodDonation.Models.User", "User")
                        .WithMany("BlogPosts")
            ...
            modelBuilder.Entity("SWD_BloodDonation.Models.BloodInventory", b =>
                {
                    b.HasOne("SWD_BloodDonation.Models.BloodComponent", "BloodComponent")
                        .WithMany("BloodInventories")
                        .HasForeignKey("BloodComponentId")
                        .HasConstraintName("FK__BloodInve__blood__5AEE82B9");

                    b.HasOne("SWD_BloodDonation.Models.BloodType", "BloodType")
                        .WithMany("BloodInventories")
            ...
            modelBuilder.Entity("SWD_BloodDonation.Models.RequestMatch", b =>
                {
                    ...
                    b.HasOne("SWD_BloodDonation.Models.DonationRequest", "DonationRequest")
                        .WithMany("RequestMatches")
